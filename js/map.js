...
window.zxc = function () {
  ...
  let apartments = window.generateApartments(APARTMENTS_COUNT);
  ...
  let renderCards = function (apartment) {
    ...
    apartmentElement.querySelector(`.popup__type`).textContent = window.translatedOfferTypes.get(apartment.offer.type);
